...
### 5. `integrity_check.py` - Verify Audio File Integrity
...
### 6. `songlink.py` - Fetch Song Links
...
## Additional Notes
- **Configuration**: Some modules use `audio-script-config.json` for settings like log folders. Edit this file to customize paths.
